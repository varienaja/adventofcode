...
public class Solutions {
  ...
  public void testDay2() {
    ...
    String input = "\n"
  ...
  public void testDay5() {
    ...
    System.out.println(pwdFor("abbhdwsy"));

    assertEquals("05ace8e3", altPwdFor("abc"));
    System.out.print("Solution 5b: ");
    System.out.println(altPwdFor("abbhdwsy"));
  }
